...
tree3 = NODE 1 (NODE 2 (LEAF 4) (LEAF 5)) (LEAF 6)
...
p4a_test7 = TestCase (assertEqual "foldTree-test7" 1  (foldTree min tree3) ) 
...
p4c_test5 = TestCase (assertEqual "fastSearch-test5" ([("node",5),("node",1),("node",10),("leaf",8),("leaf",9)])  
                                                     (fastSearch rtree1 10) )  


p4c_test6 = TestCase (assertEqual "fastSearch-test6" ([("node",5),("node",1),("node",2),("leaf",4),("leaf",5),("leaf",6),("node",10)])  
                                                     (fastSearch rtree1 5) )  
